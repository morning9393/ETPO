...
def get_config():
    ...
    parser.add_argument("--num_env_steps", type=int, default=500,
                        help='Number of environment steps to train (default: 500)')
    ...
    parser.add_argument("--episode_length", type=int,
                        default=2, help="Max length for any episode")
    ...
    # ETPO
    parser.add_argument('--model_name', type=str, default="/data/models/muning/CodeLlama-7b-hf", help="base model name/path")
